...
class Groq(Model):
    ...
    def _get_metrics(self, response_usage: CompletionUsage) -> RunMetrics:
        ...
        provider_metrics = {}
        if hasattr(response_usage, "completion_time") and response_usage.completion_time is not None:
            provider_metrics["completion_time"] = response_usage.completion_time
        if hasattr(response_usage, "prompt_time") and response_usage.prompt_time is not None:
            provider_metrics["prompt_time"] = response_usage.prompt_time
        if hasattr(response_usage, "queue_time") and response_usage.queue_time is not None:
            provider_metrics["queue_time"] = response_usage.queue_time
        if hasattr(response_usage, "total_time") and response_usage.total_time is not None:
            provider_metrics["total_time"] = response_usage.total_time
        if provider_metrics:
